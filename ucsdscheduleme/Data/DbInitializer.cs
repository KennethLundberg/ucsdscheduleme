    ...
    public class DbInitializer
    {
        public static void Initialize(ScheduleContext context)
        {
            ...
            Meeting CSE20Lecture = new Meeting()
            {
                ...
                EndTime = new DateTime(1, 1, 1, 15, 20, 0),
                Location = CENTR115,
                Code = "A00"
            };
            Meeting CSE20Discussion1 = new Meeting()
            {
                ...
                EndTime = new DateTime(1, 1, 1, 10, 50, 0),
                Location = PCYNH120,
                Code = "A02"
            };
            Meeting CSE20Discussion2 = new Meeting()
            {
                ...
                EndTime = new DateTime(1, 1, 1, 11, 50, 0),
                Location = PCYNH120,
                Code = "A03"
            };
            Meeting CSE20Discussion3 = new Meeting()
            {
                ...
                EndTime = new DateTime(1, 1, 1, 12, 50, 0),
                Location = PCYNH120,
                Code = "A04"
            };
            ...
            Meeting CSE20Final = new Meeting()
            {
                ...
                Days = Days.Saturday,
                StartTime = new DateTime(1, 1, 1, 11, 30, 0),
                EndTime = new DateTime(1, 1, 1, 14, 29, 0),
                Location = TBA,
            ...
            CSE20Lecture = new Meeting()
            {
                ...
                Days = (Days.Tuesday | Days.Thursday),
                StartTime = new DateTime(1, 1, 1, 11, 0, 0),
                EndTime = new DateTime(1, 1, 1, 12, 20, 0),
                Location = CENTR105,
                Code = "B00"
            };
            CSE20Discussion1 = new Meeting()
            {
                MeetingType = MeetingType.Discussion,
                Days = Days.Wednesday,
                StartTime = new DateTime(1, 1, 1, 16, 0, 0),
                EndTime = new DateTime(1, 1, 1, 16, 50, 0),
                Location = WLH2207,
                Code = "B01"
            };
            CSE20Discussion2 = new Meeting()
            {
                ...
                EndTime = new DateTime(1, 1, 1, 17, 50, 0),
                Location = WLH2207,
                Code = "B02"
            };
            CSE20Discussion3 = new Meeting()
            {
                ...
                EndTime = new DateTime(1, 1, 1, 18, 50, 0),
                Location = WLH2207,
                Code = "B03"
            };
            ...
            Meeting CSE11Lecture = new Meeting()
            {
                ...
                EndTime = new DateTime(1, 1, 1, 9, 20, 0),
                MeetingType = MeetingType.Lecture,
                Location = WLH2001
            };
            ...
            Meeting CSE11Review1 = new Meeting()
            {
                Days = Days.Monday,
                StartTime = new DateTime(1, 1, 1, 8, 0, 0),
                EndTime = new DateTime(1, 1, 1, 8, 50, 0),
                MeetingType = MeetingType.Review,
                Location = PETER108,
            ...
            Meeting CSE11Final = new Meeting()
            {
                Days = Days.Tuesday,
                StartTime = new DateTime(1, 1, 1, 8, 0, 0),
                EndTime = new DateTime(1, 1, 1, 10, 59, 0),
                MeetingType = MeetingType.Final,
                Location = TBA,
            ...
            Meeting CSE101Lecture1 = new Meeting()
            {
                ...
                StartTime = new DateTime(1, 1, 1, 17, 0, 0),
                EndTime = new DateTime(1, 1, 1, 18, 20, 0),
                Location = CENTR214
            };
            ...
            Meeting CSE101Discussion1 = new Meeting()
            {
                ...
                EndTime = new DateTime(1, 1, 1, 9, 50, 0),
                Location = WLH2113
            ...
            Meeting CSE101Final1 = new Meeting()
            {
                ...
                Days = Days.Thursday,
                StartTime = new DateTime(1, 1, 1, 19, 0, 0),
                EndTime = new DateTime(1, 1, 1, 21, 59, 0),
                Location = TBA
            };
