...
namespace ucsdscheduleme.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null, string remoteError = null)
        {
            ...
            string surnameClaim = @"http://schemas.xmlsoap.org/ws/2005/05/identity/claims/givenname";

            string userEmail = info.Principal.Claims.First(c => c.Type == emailClaim).Value;
            string username = info.Principal.Claims.First(c => c.Type == surnameClaim).Value;
